...
content = content.replace("مازدا (MAZDA)", "بخش")
content = content.replace("MAZDA", "بخش")
content = content.replace("مازدا", "بخش")
content = content.replace("Mazda", "بخش")
